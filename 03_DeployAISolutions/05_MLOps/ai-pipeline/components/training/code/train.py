...
def main():
    ...
    parser.add_argument('--seed', type=int, dest='seed', help='Set the seed for the training job')
    parser.add_argument('--initial_learning_rate', type=float, dest='initial_learning_rate', help='Set initial learning rate')
    parser.add_argument('--batch_size', type=int, dest='batch_size', help='Set the seed for the training job')
    parser.add_argument('--patience', type=int, dest='patience', help='Set the patience')
    parser.add_argument('--model_name', type=str, dest='model_name', help='Set the model name')
    ...
    print(f"Checking if output folder is writable: {output_folder}")
    print("Writable?" , os.access(output_folder, os.W_OK))

    model_directory = os.path.join(output_folder, args.model_name)
